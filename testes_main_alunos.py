...
class TestCalculadora(unittest.TestCase):
    ...
    def teste_operacoes_basicas(self):
        ...
        self.assertEqual(calculadora(6, 2, '/'), 3.0)
    ...
    def teste_v2_operacoes(self):
        ...
        self.assertEqual(calculadora_v2(6, 2, '/'), 3.0)
    ...
    def teste_v3_operacoes(self):
        ...
        self.assertEqual(calculadora_v3(6, 2, '/'), 3.0)
    ...
    def teste_v4_operacoes(self):
        ...
        self.assertEqual(calculadora_v4(6, 2, '/'), 3.0)
